  ...
  const tierData = [
    {
      ...
      features: [
        'Access to Google AI models and Mistral AI',
        'Basic response time',
        'Community support',
        'Standard features',
      ],
    ...
    },
    {
      ...
      features: ['All Free tier features', 'Deepseek models', 'Faster response time', 'Enhanced features'],
    ...
    },
    {
      ...
      features: ['All Tier 1 features', 'OpenAI models', 'Limited monthly word count'],
